...
const AddAgent = () => {
    ...
    return (
        <div className="py-8 max-w-[2150px] pb-8 mx-auto md:mb-80 xl:px-40 md:px-10 sm:px-2 px-4 ">
            <h1 className="text-center font-bold primary-color text-5xl">Add Agent</h1>
