...
const Footer = () => {
  return (
    <div>
      <div className="max-w-[2150px]  footer mx-auto xl:px-40 md:px-10 sm:px-2 px-4">
        <footer className="footer p-10 flex justify-between items-center  text-base-content">
          <div>
