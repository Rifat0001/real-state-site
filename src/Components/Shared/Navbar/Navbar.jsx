        ...
        <div className="navbar bg-base-100">
            <div className="sm:navbar-start md:hidden ">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu bg-black menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a>Item 1</a></li>
                        <li>
                            <a>Parent</a>
                            <ul className="p-2">
                ...
                <a className="btn btn-ghost text-primary italic font-bold text-[22px]">Real State</a>
            </div>
